...
file_path="$TEMPLATE_PATH/templates/go-gin-bearer-auth-postgres-monolithic-template/config/maker.env"
...
file_path="$TEMPLATE_PATH/templates/go-gin-bearer-auth-postgres-monolithic-template/README.md"
